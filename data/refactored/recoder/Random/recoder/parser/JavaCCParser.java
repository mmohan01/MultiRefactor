...
public class JavaCCParser implements JavaCCParserConstants {
    public void initialize(Reader r, JavaProgramFactory factory) {
        current = null;
 ...
 */
    ...
    final public EnumConstantDeclaration EnumConstant() throws ParseException {
        ...
        jj_consume_token(IDENTIFIER);
                ...
                id
         = factory.createIdentifier(token.image);
                setPrefixInfo(id);
                setPostfixInfo(id);
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            case LPAREN:
 ...
 */
    ...
    final public UncollatedReferenceQualifier TypedName() throws ParseException {
        ...
        while (true) {
            ...
            result
             = factory.createUncollatedReferenceQualifier(result, id);
            setPrefixInfo(result);
            if (jj_2_35(2)) {
                typeArguments = TypeArguments();
            } else {
          ...
          // we currently only create UncollatedReferenceQualifiers
              ...
              */}
              ...
              // this is a normal method call
                        tmpResult = factory.createMethodReference(((UncollatedReferenceQualifier)tmpResult).getReferencePrefix(),
