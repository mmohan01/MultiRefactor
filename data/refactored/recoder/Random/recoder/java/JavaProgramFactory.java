...
public class JavaProgramFactory implements ProgramFactory, PropertyChangeListener {
    ...
    private void attachComment(Comment c, ProgramElement pe) {
        ...
        if (
        c.isPrefixed() && c.getEndPosition().getLine() <  dest.getStartPosition().getLine()) {
            NonTerminalProgramElement npe = dest.getASTParent();
            if (npe != null) {
        ...
        if (commentIndex < commentCount) {
            ...
            do {
                ...
                while (dest instanceof NonTerminalProgramElement) {
                    ...
                    if ((npe.getEndPosition().compareTo(current.getStartPosition()) > 0 || ((npe.getEndPosition().compareTo(current.getStartPosition()) == 0) && newDest.getEndPosition().compareTo(
    ...
    protected class AddNewlineReader extends Reader {
