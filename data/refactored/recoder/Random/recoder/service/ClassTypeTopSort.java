...
import recoder.util.Debug; class ClassTypeTopSort implements Formats {
    ...
    public List<ClassType> getAllTypes(ClassType c) {
        ...
        if (result.size() < classesDFS.size()) {
            throw new RuntimeException("Cyclic inheritance detected!"); // TODO throw CyclicInheritanceException !?
        }
        return result;
    }
}
