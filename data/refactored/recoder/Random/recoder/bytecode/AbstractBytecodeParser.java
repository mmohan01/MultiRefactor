...
abstract public class AbstractBytecodeParser { public ClassFile parseClassFile(InputStream is, String location, boolean useJava5Features) throws IOException;
