    ...
    public static ClassFile getClassFile(String classname) {
        ...
        for (int i = 0; i < dmethods.length; i += 1) {
            ...
            if (c.isAnnotation()) {
                ...
                methods.add(new MethodInfo(m.getModifiers(), getTypeName(m.getReturnType()), false/* TODO */, m.getName(), getTypeNames(m.getParameterTypes()), getTypeNames(m.getExceptionTypes()), cf));
            }
        }
