 ...
 */
public abstract class GrammarScanner extends Scanner {
  ...
  /** lexical states */
    public int CODE = 2;
    public int EOL_COMMENT = 8;
    public int EOF_MLN_COMMENT = 14;
    public int EOF_CODE = 12;
    public int CODE_END = 10;
    public int MLN_COMMENT = 6;
    public int YYINITIAL = 0;
    public int EOF_EOL_COMMENT = 16;
    public int TEXT = 4;
   ...
   * Translates characters to character classes
   */
    private char[] ZZ_CMAP = zzUnpackCMap(ZZ_CMAP_PACKED);

  /** 
   * Translates DFA states to action switch labels.
   */
    private int[] ZZ_ACTION = zzUnpackAction();

    private String ZZ_ACTION_PACKED_0 =
    ...
    private abstract int[] zzUnpackAction() {
    ...
    private abstract int zzUnpackAction(String packed, int offset, int[] result) {
   ...
   */
    ...
    private String ZZ_ROWMAP_PACKED_0 =
    ...
    private abstract int[] zzUnpackRowMap() {
        int[] result = new int[122];
        int offset = 0;
    ...
    private abstract int zzUnpackRowMap(String packed, int offset, int[] result) {
        int i = 0;  /* index in packed string  */
        int j = offset;  /* index in unpacked array */
        int l = packed.length();
        while (i < l) {
   ...
   */
    private int[] ZZ_TRANS = zzUnpackTrans();
    ...
    private abstract int[] zzUnpackTrans() {
    ...
    private abstract int zzUnpackTrans(String packed, int offset, int[] result) {
        int i = 0;       /* index in packed string  */
        int j = offset;  /* index in unpacked array */
        int l = packed.length();
        while (i < l) {
   ...
   */
    ...
    private String ZZ_ATTRIBUTE_PACKED_0 =
    ...
    private abstract int[] zzUnpackAttribute() {
        int[] result = new int[122];
        int offset = 0;
    ...
    private abstract int zzUnpackAttribute(String packed, int offset, int[] result) {
        int i = 0;       /* index in packed string  */
        int j = offset;  /* index in unpacked array */
        int l = packed.length();
        while (i < l) {
  ...
  /* user code: */
    ...
    private abstract Symbol newSymbol(short id)
     {
        return new Symbol(id, yyline + 1, yycolumn + 1, yylength(), yytext());
    }

    private abstract Symbol newSymbol(short id, Object value)
     {
   ...
   */
    private abstract char[] zzUnpackCMap(String packed) {
   ...
   */
    private abstract boolean zzRefill() throws java.io.IOException {
   ...
   */
    private abstract void zzScanError(int errorCode) {
        String message;
        try {
   ...
   * @exception   java.io.IOException  if any I/O-Error occurs
   */
    public abstract Symbol nextToken() throws java.io.IOException, Scanner.Exception {
        int zzInput;
        int zzAction;
