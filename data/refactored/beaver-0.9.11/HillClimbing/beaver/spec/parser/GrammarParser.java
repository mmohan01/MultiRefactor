...
public abstract class GrammarParser extends Parser {
    static abstract public class Terminals { public short EOF = 0; public short IDENT = 1; public short SEMI = 2; public short TYPEOF = 3; public short HEADER = 4; public short PACKAGE = 5; public short CLASS = 6; public short EMBED = 7; public short INIT = 8; public short GOAL = 9; public short IMPORT = 10; public short IMPLEMENTS = 11; public short TERMINALS = 12; public short LEFT = 13; public short RIGHT = 14; public short NONASSOC = 15; public short BAR = 16; public short CODE = 17; public short AT = 18; public short COMMA = 19; public short TEXT = 20; public short IS = 21; public short QUESTION = 22; public short PLUS = 23; public short STAR = 24; public short DOT = 25; public String[] NAMES = {
            "EOF",
            "IDENT",
            "SEMI",
            "TYPEOF",
            ...
            "STAR",
            "DOT" };
    } ParsingTables PARSING_TABLES = new ParsingTables(
    ...
    abstract
     ...
     static class Events extends Parser.Events {
        ...
        public abstract void scannerError(Scanner.Exception e)
         {
            log.error(e);
        }
        public abstract void syntaxError(Symbol token)
         {
            log.error(token, "unexpected token");
        }
        public abstract void unexpectedTokenRemoved(Symbol token)
         {
        ...
        public abstract void misspelledTokenReplaced(Symbol token)
         {
            log.warning(token, "recovered by replacing misspelled token with '" + Terminals.NAMES[token.getId()] + "'");
        }
        public abstract void errorPhraseRemoved(Symbol error)
         {
    ...
    protected abstract Symbol invokeReduceAction(int rule_num, int offset) {
        switch (rule_num) {
            ...
            case 6: // grammar = opt$lst$declaration.decl lst$rule.rules
                { Symbol _symbol_decl = _symbols[offset + 1]; ArrayList _list_decl = (ArrayList) _symbol_decl.value; Declaration[] decl = _list_decl == null ? new Declaration[0] : (Declaration[]) _list_decl.toArray(new Declaration[_list_decl.size()]); Symbol _symbol_rules = _symbols[offset + 2]; ArrayList _list_rules = (ArrayList) _symbol_rules.value; Rule[] rules = _list_rules == null ? new Rule[0] : (Rule[]) _list_rules.toArray(new Rule[_list_rules.size()]);

                    return new GrammarTreeRoot(decl, rules);
                }
            case 20: // declaration = error.e SEMI
                { Symbol e = _symbols[offset + 1];

                    log.error(e, "malformed declaration"); return new Declaration.Error();
                }
            case 21: // header = HEADER CODE.code SEMI
                { Symbol code = _symbols[offset + 2];

                    return new Declaration.Header(code);
                }
            case 22: // package = PACKAGE TEXT.name SEMI
                { Symbol name = _symbols[offset + 2];

                    return new Declaration.PackageName(name);
                }
            case 23: // import = IMPORT txt_list.names SEMI
                { Symbol _symbol_names = _symbols[offset + 2]; ArrayList _list_names = (ArrayList) _symbol_names.value; beaver.Symbol[] names = _list_names == null ? new beaver.Symbol[0] : (beaver.Symbol[]) _list_names.toArray(new beaver.Symbol[_list_names.size()]);
            ...
            case 29: // terminals = TERMINALS sym_list.symbols SEMI
                { Symbol _symbol_symbols = _symbols[offset + 2]; ArrayList _list_symbols = (ArrayList) _symbol_symbols.value; beaver.Symbol[] symbols = _list_symbols == null ? new beaver.Symbol[0] : (beaver.Symbol[]) _list_symbols.toArray(new beaver.Symbol[_list_symbols.size()]);
            ...
            case 33: // typeof = TYPEOF sym_list.symbols IS TEXT.type SEMI
                { Symbol _symbol_symbols = _symbols[offset + 2]; ArrayList _list_symbols = (ArrayList) _symbol_symbols.value; beaver.Symbol[] symbols = _list_symbols == null ? new beaver.Symbol[0] : (beaver.Symbol[]) _list_symbols.toArray(new beaver.Symbol[_list_symbols.size()]); Symbol type = _symbols[offset + 4];
            ...
            case 38: // rule = IDENT.name IS def_list.defs SEMI
                { Symbol name = _symbols[offset + 1]; Symbol _symbol_defs = _symbols[offset + 3]; ArrayList _list_defs = (ArrayList) _symbol_defs.value; Rule.Definition[] defs = _list_defs == null ? new Rule.Definition[0] : (Rule.Definition[]) _list_defs.toArray(new Rule.Definition[_list_defs.size()]);
            ...
            case 50: // definition = opt$lst$def_element.elts opt$rule_precedence.prec opt$CODE.code
                { Symbol _symbol_elts = _symbols[offset + 1]; ArrayList _list_elts = (ArrayList) _symbol_elts.value; Rule.Definition.Element[] elts = _list_elts == null ? new Rule.Definition.Element[0] : (Rule.Definition.Element[]) _list_elts.toArray(new Rule.Definition.Element[_list_elts.size()]); Symbol prec = _symbols[offset + 2]; Symbol code = _symbols[offset + 3];
            ...
            case 56: // def_element = IDENT.name opt$alias.alias opt$ebnf_symbol.ebnf_mark
                { Symbol name = _symbols[offset + 1]; Symbol alias = _symbols[offset + 2]; Symbol ebnf_mark = _symbols[offset + 3];
