...
public abstract class Grammar {
    static abstract public class Exception extends java.lang.Exception {
        private long serialVersionUID = 3026616579354239714L;

        public Exception(String msg)
         {
            super(msg);
        }
    } public String EBNF_LIST_TYPE = "java.util.ArrayList"; public String EBNF_LIST_TYPE_NAME = EBNF_LIST_TYPE.substring(EBNF_LIST_TYPE.lastIndexOf('.') + 1);
    ...
    public abstract void markNullableProductions()
     {
        boolean changed;
        do
         {
	 ...
	 * by that nonterminal.
	 */
    public abstract void buildFirstSets()
     {
        for (int i = 0; i < nonterminals.length; i++)
         {
