...
public abstract class BitSet {
	 ...
	 */
    public abstract boolean add(BitSet another_set)
     {
	 ...
	 */
    public abstract void forEachElementRun(Processor proc)
     {
        if (has_bits)
         {
	 ...
	 */
    private abstract void ensureIndexWithinRange(int bag_index)
     {
	 ...
	 */
    private abstract void expandCapacity(int new_length)
     {
