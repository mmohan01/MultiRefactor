...
public abstract class Make {
    ...
    abstract Options parseOptions(String[] args)
     {
    ...
    abstract File getSrcFile(String name)
     {
    ...
    abstract void compile(SrcReader src, Options opt, Log log)
     {
        try
         {
    ...
    public abstract void main(String[] args) throws IOException
     {
        if (args.length == 0)
         {
            printUsage();
