...
public abstract class GrammarParser extends Parser {
    static public class Terminals { public final short EOF = 0;
    ...
    static class Events extends Parser.Events {
        ...
        public final void unexpectedTokenRemoved(Symbol token)
         {
        ...
        public final void errorPhraseRemoved(Symbol error)
         {
