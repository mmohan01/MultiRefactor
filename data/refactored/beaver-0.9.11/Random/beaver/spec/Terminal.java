...
public abstract class Terminal extends GrammarSymbol {
    static public class Associativity {
        static public Associativity LEFT = new Associativity("LEFT");
        static public Associativity RIGHT = new Associativity("RIGHT");
        static public Associativity NONE = new Associativity("NONE");
