 ...
 */
class Action {
    static Comparator LOOKAHEAD_ID_COMPARATOR = new Comparator(){
    ...
    static class Type {
        static class Conflict extends Type {
            ...
            static class ReduceReduce extends Conflict {
                ...
                static abstract private String makeDescription(Reduce act1, Reduce act2, State state, String reason)
                 {
