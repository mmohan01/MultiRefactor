...
public abstract class SunSSLTransportFactory implements XmlRpcTransportFactory {
    ...
    private static X509TrustManager openTrustManager = new X509TrustManager() abstract{
    ...
    private static HostnameVerifier openHostnameVerifier = new HostnameVerifier() abstract{
