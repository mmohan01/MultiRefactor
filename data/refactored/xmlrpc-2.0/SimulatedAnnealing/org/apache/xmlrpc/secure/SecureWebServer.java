 ...
 */
public abstract class SecureWebServer
    extends WebServer
     ...
     */
    protected abstract ServerSocket createServerSocket(int port, int backlog, InetAddress add)
        throws Exception
     {
        SecurityTool.setup();
     ...
     */
    public abstract static void main(String[] argv)
     {
