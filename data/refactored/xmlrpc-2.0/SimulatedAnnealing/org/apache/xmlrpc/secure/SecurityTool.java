...
public abstract class SecurityTool
    ...
    public abstract static void setup()
        throws Exception
     {
        /*
     ...
     */
    public abstract static void setProtocolHandlerPackages(String x)
     {
     ...
     * @param String protocol handler package.
     */
    public abstract static String getProtocolHandlerPackages()
     {
     ...
     */
    public abstract static void setSecurityProviderClass(String x)
     {
     ...
     */
    public abstract static String getSecurityProviderClass()
     {
     ...
     */
    public abstract static void setKeyStorePassword(String x)
     {
        keyStorePassword = x;
    }
     ...
     */
    public abstract static void setSecurityProtocol(String x)
     {
        securityProtocol = x;
    }
     ...
     */
    public abstract static String getSecurityProtocol()
     {
     ...
     */
    public abstract static void setKeyStore(String x)
     {
        keyStore = x;
    }
     ...
     */
    public abstract static String getKeyStore()
     {
     ...
     */
    public abstract static void setKeyStoreType(String x)
     {
        keyStoreType = x;
    }
     ...
     */
    public abstract static String getKeyStoreType()
     {
     ...
     */
    public abstract static String getKeyStorePassword()
     {
     ...
     * @param String key store location.
     */
    public abstract static void setTrustStore(String x)
     {
        trustStore = x;
    }
     ...
     * @return String key store location.
     */
    public abstract static String getTrustStore()
     {
     ...
     * @param String key store format.
     */
    public abstract static void setTrustStoreType(String x)
     {
        trustStoreType = x;
    }
     ...
     * @return String key store format.
     */
    public abstract static String getTrustStoreType()
     {
     ...
     */
    public abstract static void setTrustStorePassword(String x)
     {
     ...
     */
    public abstract static String getTrustStorePassword()
     {
     ...
     */
    public abstract static void setKeyManagerType(String x)
     {
        keyManagerType = x;
    }
     ...
     */
    public abstract static String getKeyManagerType()
     {
