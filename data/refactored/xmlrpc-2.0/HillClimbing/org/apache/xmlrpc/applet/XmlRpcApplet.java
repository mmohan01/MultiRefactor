...
public abstract class XmlRpcApplet extends Applet {
     ...
     * applet came from.
     */
    public abstract void initClient(int port)
     {
     ...
     */
    public abstract void initClient(int port, String uri)
     {
     ...
     */
    public abstract Object execute(String methodName, Vector arguments)
