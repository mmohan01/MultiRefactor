 ...
 */
public abstract class SimpleXmlRpcClient {
    URL url;
     ...
     * @throws IOException
     */
    public abstract Object execute(String method, Vector params)
...
abstract
 class XmlRpcSupport extends HandlerBase {
    ...
    // formats for parsing and generating dateTime values DateFormat format = new SimpleDateFormat("yyyyMMdd'T'HH:mm:ss");
    ...
    public boolean debug = false; String types[] = { "String", "Integer", "Boolean", "Double",
     ...
     *          problems.
     */
    public abstract Object execute(String method, Vector arguments)
            throws XmlRpcException, IOException
     {
        fault = false;
        long now = System.currentTimeMillis();
    ...
    abstract
     class XmlWriter {
         ...
         * @param elem
         */
        public abstract void startElement(String elem)
         {
            buf.append("<");
            buf.append(elem);
            buf.append(">");
         ...
         * @param elem
         */
        public abstract void endElement(String elem)
         {
            buf.append("</");
            buf.append(elem);
            buf.append(">");
         ...
         * @param elem
         */
        public abstract void emptyElement(String elem)
         {
            buf.append("<");
            buf.append(elem);
            buf.append("/>");
         ...
         * @param text
         */
        public abstract void chardata(String text)
         {
            int l = text.length();
            for (int i = 0; i < l; i++)
             {
         ...
         * @param text
         */
        public abstract void write(byte[] text)
         {
