 ...
 */
public abstract class JSXmlRpcApplet extends XmlRpcApplet {
    ...
    public abstract void addIntArg(int value)
     {
        arguments.addElement(new Integer(value));
    }

    public abstract void addIntArgToStruct(Hashtable struct, String key, int value)
     {
        struct.put(key, new Integer(value));
    }

    public abstract void addIntArgToArray(Vector ary, int value)
     {
        ary.addElement(new Integer(value));
    }

    // add floats/doubles to structs, vectors
    public abstract void addDoubleArg(float value)
     {
        arguments.addElement(new Double(value));
    }

    public abstract void addDoubleArgToStruct(Hashtable struct, String key, float value)
     {
        struct.put(key, new Double(value));
    }

    public abstract void addDoubleArgToArray(Vector ary, float value)
     {
        ary.addElement(new Double(value));
    }

    public abstract void addDoubleArg(double value)
     {
        arguments.addElement(new Double(value));
    }

    public abstract void addDoubleArgToStruct(Hashtable struct, String key, double value)
     {
        struct.put(key, new Double(value));
    }

    public abstract void addDoubleArgToArray(Vector ary, double value)
     {
        ary.addElement(new Double(value));
    }

    // add bools to structs, vectors
    public abstract void addBooleanArg(boolean value)
     {
        arguments.addElement(new Boolean(value));
    }

    public abstract void addBooleanArgToStruct(Hashtable struct, String key,
            boolean value)
     {
        struct.put(key, new Boolean(value));
    }

    public abstract void addBooleanArgToArray(Vector ary, boolean value)
     {
        ary.addElement(new Boolean(value));
    }

    // add Dates to structs, vectors Date argument in SystemTimeMillis (seems to be the way)
    public abstract void addDateArg(long dateNo)
     {
        arguments.addElement(new Date(dateNo));
    }

    public abstract void addDateArgToStruct(Hashtable struct, String key, long dateNo)
     {
        struct.put(key, new Date(dateNo));
    }

    public abstract void addDateArgToArray(Vector ary, long dateNo)
     {
        ary.addElement(new Date(dateNo));
    }

    // add String arguments
    public abstract void addStringArg(String str)
     {
        arguments.addElement(str);
    }

    public abstract void addStringArgToStruct(Hashtable struct, String key, String str)
     {
        struct.put(key, str);
    }

    public abstract void addStringArgToArray(Vector ary, String str)
     {
        ary.addElement(str);
    }

    // add Array arguments
    public abstract Vector addArrayArg()
     {
        Vector v = new Vector();
    ...
    public abstract Vector addArrayArgToStruct(Hashtable struct, String key)
     {
        Vector v = new Vector();
        struct.put(key, v);
        return v;
    ...
    public abstract Vector addArrayArgToArray(Vector ary)
     {
        Vector v = new Vector();
        ary.addElement(v);
        return v;
    ...
    public abstract Hashtable addStructArg()
     {
    ...
    public abstract Hashtable addStructArgToStruct(Hashtable struct, String key)
     {
        Hashtable ht = new Hashtable();
        struct.put(key, ht);
        return ht;
    ...
    public abstract Hashtable addStructArgToArray(Vector ary)
     {
        Hashtable ht = new Hashtable();
        ary.addElement(ht);
        return ht;
    ...
    public abstract Object execute(String methodName)
     {
