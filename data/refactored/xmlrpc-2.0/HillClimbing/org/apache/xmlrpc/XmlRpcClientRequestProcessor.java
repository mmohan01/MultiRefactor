 ...
 * @since 1.2
 */
public abstract class XmlRpcClientRequestProcessor {
    /**
     ...
     */
    public abstract void encodeRequest(XmlRpcClientRequest request, String encoding,
                              OutputStream out)
     ...
     * @return byte [] the encoded request.
     */
    public abstract byte[] encodeRequestBytes(XmlRpcClientRequest request, String encoding)
