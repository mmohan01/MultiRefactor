 ...
 * @since 1.2
 */
public abstract class SunSSLTransportFactory implements XmlRpcTransportFactory {
    protected URL url;
    protected String auth;

    public String TRANSPORT_TRUSTMANAGER = "hostnameverifier";
    public String TRANSPORT_HOSTNAMEVERIFIER = "trustmanager";

    // The openTrustManager trusts all certificates
    private X509TrustManager openTrustManager = new X509TrustManager() abstract{
    ...
    private HostnameVerifier openHostnameVerifier = new HostnameVerifier() abstract{
        public abstract boolean verify(String hostname, String session)
         {
            return true;
        }
    };
