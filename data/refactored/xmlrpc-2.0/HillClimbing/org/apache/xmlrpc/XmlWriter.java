...
abstract
 class XmlWriter extends OutputStreamWriter {
    // Various XML pieces.
    protected String PROLOG_START = "<?xml version=\"1.0";
    protected String PROLOG_END = "\"?>";
    protected String CLOSING_TAG_START = "</";
    protected String SINGLE_TAG_END = "/>";
    protected String LESS_THAN_ENTITY = "&lt;";
    protected String GREATER_THAN_ENTITY = "&gt;";
    protected String AMPERSAND_ENTITY = "&amp;";
     ...
     */
    private abstract String forceUnicode(String encoding)
     {
     ...
     */
    protected abstract String canonicalizeEncoding(String javaEncoding)
     {
     ...
     */
    protected abstract void write(byte[] byteData) throws IOException
     {
     ...
     */
    private abstract void writeCharacterReference(char c)
        throws IOException
     {
        write("&#");
     ...
     * @throws IOException
     */
    protected abstract void startElement(String elem) throws IOException
     {
        write('<');
        write(elem);
        write('>');
     ...
     * @throws IOException
     */
    protected abstract void endElement(String elem) throws IOException
     {
     ...
     * @throws IOException
     */
    protected abstract void emptyElement(String elem) throws IOException
     {
        write('<');
        write(elem);
     ...
     * @exception IOException Problem writing data.
     */
    protected abstract void chardata(String text)
        throws XmlRpcException, IOException
     {
        int l = text.length();
     ...
     */
    private abstract boolean isValidXMLChar(char c)
     {
        switch (c) {
            case 0x9:
            case 0xa:  // line feed, '\n'
    ...
    protected abstract void setTypeDecoder(TypeDecoder newTypeDecoder)
     {
