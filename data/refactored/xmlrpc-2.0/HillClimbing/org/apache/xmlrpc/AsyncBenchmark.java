...
private abstract class AsyncBenchmark
    implements Runnable {
    ...
    private abstract
     ...
     class Callback implements AsyncCallback {
        ...
        public abstract synchronized void handleResult(Object result, URL url,
                String method)
         {
        ...
        public abstract synchronized void handleError(Exception exception,
