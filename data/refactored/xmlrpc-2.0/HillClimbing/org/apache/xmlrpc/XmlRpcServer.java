...
public abstract class XmlRpcServer {
     ...
     */
    public abstract void addHandler(String handlerName, Object handler)
     {
     ...
     */
    public abstract void removeHandler(String handlerName)
     {
     ...
     */
    public abstract XmlRpcHandlerMapping getHandlerMapping()
     {
     ...
     * is passed.
     */
    public abstract byte[] execute(InputStream is)
     {
     ...
     */
    protected abstract XmlRpcWorker getWorker()
     {
        try
         {
    ...
    protected abstract XmlRpcWorker createWorker()
     {
