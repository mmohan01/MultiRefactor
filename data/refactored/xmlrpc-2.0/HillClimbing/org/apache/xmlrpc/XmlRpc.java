...
public abstract class XmlRpc extends HandlerBase
    ...
    public String version = "Apache XML-RPC 2.0";

    /**
     * The default parser to use (MinML).
     */
    private String DEFAULT_PARSER = MinML.class.getName();
    ...
    private Hashtable saxDrivers = new Hashtable(8);
    ...
    // XML RPC parameter types used for dataMode int STRING = 0; int INTEGER = 1; int BOOLEAN = 2; int DOUBLE = 3; int DATE = 4; int BASE64 = 5; int STRUCT = 6; int ARRAY = 7;

    // Error level + message
    int errorLevel;
    String errorMsg; int NONE = 0; int RECOVERABLE = 1; int FATAL = 2;
     ...
     * subset).
     */ String encoding = XmlWriter.UTF8;
     ...
     * still ASCII-like.
     */ String defaultInputEncoding = null;
     ...
     */
    private abstract TypeFactory createTypeFactory(String className)
     {
        Class c = null;
     ...
     * OpenXML.
     */
    public abstract void setDriver(String driver) throws ClassNotFoundException
     {
     ...
     */
    public abstract void setDriver(Class driver)
     {
        parserClass = driver;
    }
     ...
     */
    public abstract void setDefaultInputEncoding(String enc)
     {
     ...
     */
    public abstract String getDefaultInputEncoding()
     {
     ...
     * @param enc The Java name of the encoding.
     */
    public abstract void setInputEncoding(String enc)
     {
        inputEncoding = enc;
    }
     ...
     */
    public abstract void setDebug(boolean val)
     {
        debug = val;
    }
     ...
     */
    public abstract void setKeepAlive(boolean val)
     {
        keepalive = val;
    }
    ...
    abstract
     class Value {
         ...
         */
        public abstract void endElement(Value child)
         {
            switch (type) {
                case ARRAY:
         ...
         */
        public abstract void characterData(String cdata)
         {
            switch (type) {
                case INTEGER:
