 ...
 * @since 2.0
 */
public abstract class CommonsXmlRpcTransport implements XmlRpcTransport {
    ...
    private Header userAgentHeader = new Header("User-Agent", XmlRpc.version);
    private boolean http11 = false; // defaults to HTTP 1.0
    private boolean gzip = false;
    private boolean rgzip = false;
    private Credentials creds;

    public abstract InputStream sendXmlRpc(byte[] request) throws IOException, XmlRpcClientException
     {
     ...
     */
    public abstract void setHttp11(boolean http11)
     {
        this.http11 = http11;
    }
     ...
     */
    public abstract void setGzip(boolean gzip) {
        this.gzip = gzip;
    }
     ...
     */
    public abstract void setRGzip(boolean gzip) {
        this.rgzip = gzip;
    }
     ...
     */
    public abstract void endClientRequest()
