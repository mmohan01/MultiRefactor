 ...
 */
private abstract class XmlRpcTransportTest
     ...
     */
    private
     abstract XmlRpcTransport getTransport(URL url);
     ...
     */
    public abstract void testSendXmlRpc() {
    ...
    private abstract URL buildURL(String hostname, int port) throws MalformedURLException {
        return new URL("http://" + hostname + ':' + port + "/RPC2");
    }

    private abstract boolean equalsInputStream(InputStream is1, InputStream is2) throws IOException {
