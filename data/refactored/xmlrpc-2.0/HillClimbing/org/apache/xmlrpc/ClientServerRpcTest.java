 ...
 */
private abstract class ClientServerRpcTest
     ...
     * comparisons.
     */
    private String SAX_DRIVER = "uk.co.wilson.xml.MinML";

    /**
     * The number of RPCs to make for each test.
     */
    private int NBR_REQUESTS = 1000;

    /**
     * The number of calls to batch in the multicall.
     */
    private int NUM_MULTICALLS = 10;
     ...
     */
    public abstract void testServer()
     {
        try
         {
    ...
    public abstract void testSystemMultiCall()
     {
        try
         {
