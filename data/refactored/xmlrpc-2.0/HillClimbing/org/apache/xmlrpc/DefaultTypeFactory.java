 ...
 * @since 1.2
 */
public abstract class DefaultTypeFactory
    ...
    public abstract Object createInteger(String cdata)
     {
        return new Integer(cdata.trim());
    }

    public abstract Object createBoolean(String cdata)
     {
        return ("1".equals(cdata.trim()) ? Boolean.TRUE : Boolean.FALSE);
    }

    public abstract Object createDouble(String cdata)
     {
        return new Double(cdata.trim());
    }

    public abstract Object createDate(String cdata)
     {
        try
         {
    ...
    public abstract Object createBase64(String cdata)
     {
        try
         {
    ...
    public abstract Object createString(String cdata)
     {
        return cdata;
    }
}
