 ...
 */
private abstract class XmlWriterTest
    extends TestCase {
    ...
    public abstract void testForceAlternateEncoding()
        throws Exception
     {
    ...
    public abstract void testProlog()
        throws IOException
     { String EXPECTED_PROLOG =
    ...
    public abstract void testBasicResults()
        throws Exception
     {
        try
         {
    ...
    public abstract void testWriteCharacterReference()
        throws Exception
     {
        writer = new XmlWriter(buffer, null);
