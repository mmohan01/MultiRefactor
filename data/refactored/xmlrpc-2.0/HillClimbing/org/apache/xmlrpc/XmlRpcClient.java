 ...
 */
public abstract class XmlRpcClient implements XmlRpcHandler {
    protected URL url;
     ...
     */
    public abstract void setBasicAuthentication(String user, String password)
     {
        /*
    ...
    public abstract Object execute(XmlRpcClientRequest request)
            throws XmlRpcException, IOException
     {
        return execute(request, createTransport());
    }

    public abstract Object execute(XmlRpcClientRequest request, XmlRpcTransport transport)
            throws XmlRpcException, IOException
     {
     ...
     */
    public abstract void executeAsync(String method, Vector params,
    ...
    public abstract void executeAsync(XmlRpcClientRequest request,
            AsyncCallback callback)
     {
    ...
    protected abstract XmlRpcTransport createTransport() throws XmlRpcClientException
     {
    ...
    private abstract DefaultXmlRpcTransport createDefaultTransport() {
