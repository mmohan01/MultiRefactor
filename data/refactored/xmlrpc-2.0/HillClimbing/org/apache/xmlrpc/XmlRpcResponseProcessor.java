 ...
 * @since 1.2
 */
public abstract class XmlRpcResponseProcessor {
     ...
     */
    public abstract byte[] encodeResponse(Object responseParam, String encoding)
     ...
     * @return byte[] The XML-RPC response.
     */
    public abstract byte[] encodeException(Exception x, String encoding, int code)
     {
        if (XmlRpc.debug)
         {
            x.printStackTrace();
     ...
     * @return byte[] The XML-RPC response.
     */
    public abstract byte[] encodeException(Exception x, String encoding)
     {
