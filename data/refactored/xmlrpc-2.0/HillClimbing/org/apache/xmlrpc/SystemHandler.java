...
public abstract class SystemHandler
 implements ContextXmlRpcHandler {
   ...
   /**
     ...
     * </dl>
     */
    public abstract void addDefaultSystemHandlers()
     {
     ...
     */
    public abstract void addSystemHandler(String handlerName, ContextXmlRpcHandler handler)
     {
     ...
     */
    public abstract void removeSystemHandler(String handlerName)
     {
     ...
     */
    public abstract Object execute(String method, Vector params, XmlRpcContext context)
            throws Exception
     {
        Object handler = null;
