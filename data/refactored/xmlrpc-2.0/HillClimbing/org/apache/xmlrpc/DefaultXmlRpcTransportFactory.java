 ...
 * @since 1.2
 */
public abstract class DefaultXmlRpcTransportFactory implements XmlRpcTransportFactory {
    ...
    public String DEFAULT_HTTPS_PROVIDER = "comnetsun";

    private Hashtable transports = new Hashtable(1);
    ...
    public abstract void setHTTPSTransport(String transport, Properties properties)
        throws XmlRpcClientException
     {
        httpsTransportFactory = createTransportFactory(transport, properties);
    }

    public abstract XmlRpcTransportFactory createTransportFactory(String transport, Properties properties)
        throws XmlRpcClientException
     {
    ...
    public abstract XmlRpcTransport createTransport()
     throws XmlRpcClientException
     {
