...
public final class InheritanceMetrics {
    @TypeMetric
     public void calculateInterfacesMetrics(Type type, MetricRow row) {
        row.set("iFImpl", type.getInterfaces().size());
        row.set("NOC", type.getExtenders().size());
    }

    @TypeMetric
     public void calculateNumberOfDesc(Type type, MetricRow row) {
    ...
    @TypeMetric
     public void calculateNumberOfAnc(Type type, MetricRow row) {
