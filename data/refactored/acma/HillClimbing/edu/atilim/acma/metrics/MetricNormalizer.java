...
public class MetricNormalizer {
    ...
    public double normalize(MetricSummary current, RunConfig config) {
        return weightedNormalize(current, config);
    }

    public HashMap<String, Double> normalizeEach(MetricSummary current, RunConfig config) {
        // All metrics
    ...
    private double weightedNormalize(MetricSummary current, RunConfig config) {
        // All metrics
        List<MetricRegistry.Entry> metrics = MetricRegistry.entries();
        int nummetrics = metrics.size();
    ...
    @SuppressWarnings("unused")
     private double unweightedNormalize(MetricSummary current, RunConfig config) {
        // All metrics
        List<MetricRegistry.Entry> metrics = MetricRegistry.entries();
        int nummetrics = metrics.size();
    ...
    private double[][] getMeansAndStDevs(double[][] table, int metrics, int designs) {
