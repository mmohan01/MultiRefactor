...
public final class PackageMetrics {
    @PackageMetric
     public void calculateAbstractness(Package pack, MetricRow row) {
        int abst = 0;
        int totl = 0;
    ...
    @PackageMetric
     public void calculateCounts(Package pack, MetricRow row) {
    ...
    @PackageMetric
     public void calculateNesting(Package pack, MetricRow row) {
