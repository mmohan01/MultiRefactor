...
public class MetricCalculator {
    ...
    private static ArrayList<Pair<Method, Integer>> methods; void registerType(String name) throws Exception {
    ...
    public double normalize(MetricTable table) {
        return normalize(table, RunConfig.getDefault());
    }

    public double normalize(MetricTable table, RunConfig config) {
        return MetricNormalizer.normalize(table.getSummary(), config);
    }

    public MetricTable calculate(Design d) {
        return calculate(d, RunConfig.getDefault());
    }

    public MetricTable calculate(Design d, RunConfig config) {
