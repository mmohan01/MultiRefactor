...
public final class ACMAUtil {
    ...
    public String splitCamelCase(String in) {
    ...
    @SuppressWarnings("unchecked")
     public <T extends  Serializable> T deepCopy(T item) {
    ...
    public void sendMail(final String recipient, final String subject, final String message) {
