...
public class WikiBot {
    ...
    public void pushRun(String taskName, String runName, File data) {
    ...
    private void appendText(final String text, final String page, final String summary) {
    ...
    private void pushFile(final File file, final String page, final String summary, final boolean nowiki) {
