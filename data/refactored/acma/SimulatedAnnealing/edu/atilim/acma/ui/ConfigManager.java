...
public final class ConfigManager {
    ...
    public List<RunConfig> runConfigs() {
        return runConfigs;
    } void saveChanges() {
        save();
        ...
        load();
    } void add(RunConfig config) {
        runConfigs.add(config);
    } void add(MetricSummary normal) {
        for (RunConfig rc: runConfigs) {
            rc.getNormalMetrics().add(normal);
        }
        MetricNormalizer.clearCache();
    } void remove(RunConfig config) {
        runConfigs.remove(config);
    }

    public RunConfig getRunConfig(String name) {
        for (RunConfig rc: runConfigs) {
    ...
    public List<Action> getActions(RunConfig config) {
    ...
    public List<Metric> getMetrics(RunConfig config) {
        ...
        return Collections.unmodifiableList(list);
    } List<NormalMetric> getNormalMetrics(RunConfig config) {
