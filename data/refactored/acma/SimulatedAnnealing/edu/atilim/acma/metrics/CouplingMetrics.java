...
public final class CouplingMetrics {
    @TypeMetric
     public void calculateAttrMetrics(Type type, MetricRow row) {
    ...
    @TypeMetric
     public void calculateMethodMetrics(Type type, MetricRow row) {
    ...
    @TypeMetric
     public void calculateDependenceMetrics(Type type, MetricRow row) {
    ...
    //@TypeMetric
    public void calculateAssocElementsMetrics(Type type, MetricRow row) {
