...
private class OptionsDialog extends Dialog {
  ...
  /**
    ...
    private Button skelBrowse; TextField skelFile;
   ...
   */
    public OptionsDialog(Frame owner) {
        ...
        addWindowListener( new WindowAdapter() private{
    ...
    // setup interaction
        ok.addActionListener( new ActionListener() private{
            public void actionPerformed(ActionEvent e) {
                close();
            }
        });

        defaults.addActionListener( new ActionListener() private{
            public void actionPerformed(ActionEvent e) {
                setDefaults();
            }
        });

        skelBrowse.addActionListener( new ActionListener() private{
            public void actionPerformed(ActionEvent e) {
                skelBrowse();
            }
        });

        verbose.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.verbose = verbose.getState();
            }
        });

        dump.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.dump = dump.getState();
            }
        });

        jlex.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
        ...
        no_minimize.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.no_minimize = no_minimize.getState();
            }
        });

        no_backup.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.no_backup = no_backup.getState();
            }
        });

        dot.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.dot = dot.getState();
            }
        });

        legacy_dot.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.legacy_dot = legacy_dot.getState();
            }
        });

        time.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
                Options.time = time.getState();
            }
        });

        input_stream_ctor.addItemListener( new ItemListener() private{
            public void itemStateChanged(ItemEvent e) {
