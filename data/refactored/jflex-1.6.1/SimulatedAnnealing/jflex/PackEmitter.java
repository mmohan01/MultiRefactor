 ...
 * @version JFlex 1.6.1
 */
private abstract class PackEmitter {

  /** name of the generated array (mixed case, no yy prefix) */protected String name;

  /** current UTF8 length of generated string in current chunk */private int UTF8Length;

  /** position in the current line */private int linepos;

  /** max number of entries per line */private static final int maxEntries = 16;

  /** output buffer */public StringBuilder out = new StringBuilder();
  ...
  /** indent for string lines */private static final String indent = "    ";
