...
final public class DFA {
  ...
  /** True iff this DFA contains general lookahead */
    ...
    public final void setFinal(int state, boolean isFinalState) {
   ...
   */
    ...
    // and mark pairs (final state, not final state) as not equivalent
        ...
        for (i = 1; i < numStates; i++) {
            ...
            for (j = 0; j < i; j++) {
                ...
                // printTable(equiv); // if (p >= 0) .. // if (equiv[i][j] // for (char c = 0; c < numInput ..
                                }
                            }
                        }
                    }
    ...
    } // of first if (equiv[i][j]) // of for j // of for i
    // }
                }
            }
        }
