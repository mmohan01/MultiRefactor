   ...
   */
    public static void generate(File inputFile) {
        ...
        try {
            ...
            Out.
            println(ErrorMessages.NFA_STATES, nfa.numStates);
    ...
    public static List<File> parseOptions(final String argv[]) throws SilentExit {
   ...
   */
    private static void printUnicodePropertyValuesAndAliases(String unicodeVersion)
      throws UnicodeProperties.UnsupportedUnicodeVersionException {
        ...
        String underscoreVersion = matcher.group(1) + (null == matcher.group(2) ? "_0" : "_" + matcher.group(2));
        ...
        SortedMap<String, SortedSet<String>> propertyValuesToAliases = new TreeMap<String, SortedSet<String>>();
