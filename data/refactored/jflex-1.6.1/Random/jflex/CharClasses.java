...
protected class CharClasses {
  ...
  /** the largest character actually used in a specification */
    private static int maxCharUsed;
   ...
   */
    public void init(int maxCharCode, LexScan scanner) {
        if (maxCharCode < 0) {
            ...
            throw new IllegalArgumentException("maxCharCode " + Integer.toHexString(maxCharCode) + " is larger than maxChar " + Integer.toHexString(maxChar));
        }
   ...
   */
    public final int[] getNotClassCodes(List<Interval> intervalList) {
