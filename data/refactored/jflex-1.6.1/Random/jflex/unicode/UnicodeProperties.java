...
public final class UnicodeProperties {
    ...
    private int caselessMatchPartitionSize; IntCharSet caselessMatches[];
   ...
   *  Unicode version.
   */
    private void bind(String[] propertyValues, final String[] intervals,
