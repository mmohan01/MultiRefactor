 ...
 * @version JFlex 1.6.1
 */
final abstract public class Emitter {
    private static Pattern JAVADOC_COMMENT_AND_MAYBE_ANNOTATIONS_PATTERN = Pattern.compile(".*/\\*\\*(.*)\\*/"               // javadoc comment, embedded '*/' disallowed
          +
     ...
     ")*\\s*",                         // zero or more annotations, followed by optional whitespace
           Pattern
    .DOTALL | Pattern.CASE_INSENSITIVE | Pattern.COMMENTS);
