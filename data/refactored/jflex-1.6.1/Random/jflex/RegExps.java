   ...
   *  Need 2*gen_look_count additional DFA entry points. */
    ...
    public int insert(int line, List<Integer> stateList, RegExp regExp, Action action,
        ...
        if (Options.DEBUG) {
            ...
            Out.
            debug("and action code :" + Out.NL + action.content + Out.NL);     //$NON-NLS-1$
            Out.
            debug("expression :" + Out.NL + regExp);  //$NON-NLS-1$
        }
    ...
    public void addStates(int regNum, final List<Integer> newStates) {
