 ...
 */
public class VersionManagement { static String JHOTDRAW_COMPONENT = "CH.ifa.draw/";
...
//		Package pack = VersionManagement.class.getPackage();
	 ...
	 */
    public String readVersionFromFile(String applicationName, String versionFileName) {
        try {
