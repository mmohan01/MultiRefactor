...
public class StandardFigureSelection implements FigureSelection, Serializable { byte[] fData; // flattend figures, ready to be resurrected

    /**
	 * The type identifier of the selection.
	 */
    protected final static String TYPE = "CH.ifa.draw.Figures";
    ...
    public FigureEnumeration duplicateFigures(FigureEnumeration toBeCloned, int figureCount) {
