 ...
 */ class FontSizeHandle extends LocatorHandle {
    ...
    public void invokeEnd(int x, int y, int anchorX, int anchorY, DrawingView view) {
        ...
        if (
        textOwner.getFont().getSize() == activity.getOldFontSize()) {
	 ...
	 */
    public Undoable createUndoActivity(DrawingView newView) {
        TextFigure textOwner = (TextFigure)owner();
        return new FontSizeHandle.UndoActivity(newView, textOwner.getFont());
    }

    private static class UndoActivity extends UndoableAdapter {
        private Font myFont;
        ...
        public void setOldFontSize(int newOldFontSize) {
