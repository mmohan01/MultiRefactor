 ...
 */
protected class UndoableCommand implements Command, FigureSelectionListener, CommandListener {
    ...
    public void execute() {
        ...
        view().
        addFigureSelectionListener(this);
    ...
    public void setWrappedCommand(Command newWrappedCommand) {
    ...
    public AbstractCommand.EventDispatcher getEventDispatcher() {
