...
private  class DrawApplication
    ...
    protected JMenu createFileMenu() {
        ...
        Command cmd = new AbstractCommand("New", this, false) private{
            public void execute() {
                promptNew();
            }
        };
        ...
        cmd = new AbstractCommand("Open...", this, false) private{
            public void execute() {
                promptOpen();
            }
        };
        ...
        cmd = new AbstractCommand("Save As...", this, true) private{
            public void execute() {
                promptSaveAs();
            }
        };
        ...
        cmd = new AbstractCommand("Print...", this, true) private{
            public void execute() {
                print();
            }
        };
        ...
        cmd = new AbstractCommand("Exit", this, true) private{
            public void execute() {
                exit();
            }
        };
    ...
    protected JMenu createDebugMenu() {
        ...
        Command cmd = new AbstractCommand("Simple Update", this) private{
        ...
        cmd = new AbstractCommand("Buffered Update", this) private{
            public void executable() {
    ...
    public JMenu createLookAndFeelMenu() {
        ...
        for (int i = 0; i < lafs.length; i++) {
            ...
            Command cmd = new AbstractCommand(lafs[i].getName(), this) private{
                public void execute() {
    ...
    public String[] getRequiredVersions() {
        ...
        requiredVersions[
        0] = VersionManagement.getPackageVersion(DrawApplication.class.getPackage());
