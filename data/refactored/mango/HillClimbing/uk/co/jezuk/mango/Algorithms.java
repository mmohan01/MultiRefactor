...
public abstract class Algorithms {
   ...
   */ public abstract <T> List<T> intersection(Collection<? extends  T> coll1,
                     Collection<? extends  T> coll2)
     { return Intersection.execute(coll1.iterator(), coll2, new ArrayList<T>()); } public abstract <T, C extends  Collection<? super  T>>
                  C intersection(Collection<? extends  T> coll1,
                         Collection<? extends  T> coll2,
                         C results)
     { return Intersection.execute(coll1.iterator(), coll2, results); } public abstract <T> List<T> intersection(Iterator<? extends  T> iter1,
                     Collection<? extends  T> coll2)
     { return Intersection.execute(iter1, coll2, new ArrayList<T>()); } public abstract <T, C extends  Collection<? super  T>>
                  C intersection(Iterator<? extends  T> iter1,
                         Collection<? extends  T> coll2,
                         C results)
     { return Intersection.execute(iter1, coll2, results); }

    abstract public <T> List<T> intersection(Iterator<? extends  T> iter1,
                     Iterator<? extends  T> iter2)
     { return Intersection.execute(iter1, iter2, new ArrayList<T>()); } public abstract <T, C extends  Collection<? super  T>>
                  C intersection(Iterator<? extends  T> iter1,
                         Iterator<? extends  T> iter2,
                         C results)
   ...
   */ public abstract <T> List<T> symmetricDifference(Collection<? extends  T> coll1,
                                                Collection<? extends  T> coll2)
     { return SymmetricDifference.execute(coll1.iterator(), coll2, new ArrayList<T>()); } public abstract <T, C extends  Collection<? super  T>> C symmetricDifference(Collection<? extends  T> coll1,
                                                                           Collection<? extends  T> coll2,
                                                                           C results)
     { return SymmetricDifference.execute(coll1.iterator(), coll2, results); } public abstract <T> List<T> symmetricDifference(Iterator<? extends  T> iter1,
                                                Collection<? extends  T> coll2)
     { return SymmetricDifference.execute(iter1, coll2, new ArrayList<T>()); }

    abstract public <T, C extends  Collection<? super  T>> C  symmetricDifference(Iterator<? extends  T> iter1,
                                                                            Collection<? extends  T> coll2,
                                                                            C results)
     { return SymmetricDifference.execute(iter1, coll2, results); }

    abstract public <T> List<T> symmetricDifference(Iterator<? extends  T> iter1,
                                                Iterator<? extends  T> iter2)
   ...
   */
    abstract public <T, R> void forEach(Collection<T> collection,
    ...
    abstract public <T, R> void forEach(List<T> list,
                                    int start,
                                    int end,
                                    Function<? super  T, R> fn)
     { ForEach.execute(Iterators.BoundedIterator(list, start, end), fn); }

    abstract public <T, R> void forEach(Iterator<T> iterator,
                                    Function<? super  T, R> fn)
   ...
   * <code>results</code>.
   */
    abstract public <T, R> List<R> transform(Collection<T> collection,
                                         Function<? super  T, R> fn)
     { return Transform.execute(collection.iterator(), fn, new ArrayList<R>()); }

    abstract public <T, R, C extends  Collection<? super  R>>
    ...
    abstract public <T, R> List<R> transform(List<T> collection,
                                         int start,
                                         int end,
                                         Function<? super  T, R> fn)
    ...
    abstract public <T, R> List<R> transform(Iterator<T> iterator,
                                         Function<? super  T, R> fn)
   ...
   */
    abstract public <T> int count(Collection<? extends  T> collection,
                              T value)
    ...
    abstract public <T> int count(List<? extends  T> list,
                              int start,
                              int end,
                              T value)
     { return Count.execute(Iterators.BoundedIterator(list, start, end), value); }

    abstract public <T> int count(Iterator<? extends  T> iterator,
                              T value)
   ...
   * is <code>true</code>.
   */
    abstract public <T> int countIf(Collection<T> collection,
    ...
    abstract public <T> int countIf(List<T> list,
                                int start,
                                int end,
                                Predicate<? super  T> test)
     { return CountIf.execute(Iterators.BoundedIterator(list, start, end), test); }

    abstract public <T> int countIf(Iterator<T> iterator,
                                Predicate<? super  T> test)
   ...
   * is <code>false</code>.
   */
    abstract public <T> int countIfNot(Collection<T> collection,
                                   Predicate<? super  T> test)
    ...
    abstract public <T> int countIfNot(List<T> list,
                                   int start,
                                   int end,
                                   Predicate<? super  T> test)
     { return CountIfNot.execute(Iterators.BoundedIterator(list, start, end), test); }

    abstract public <T> int countIfNot(Iterator<T> iterator,
                                   Predicate<? super  T> test)
   ...
   * <code>Object.equals</code> (unless <code>value</code> is <code>null</code>).
   */
    abstract public <T> T find(Collection<? extends  T> collection,
                           T value)
    ...
    abstract public <T> T find(List<? extends  T> list,
                           int start,
                           int end,
                           T value)
     { return Find.execute(Iterators.BoundedIterator(list, start, end), value); }

    abstract public <T> T find(Iterator<? extends  T> iterator,
                           T value)
   ...
   * <code>Object.equals</code> (unless <code>value</code> is <code>null</code>).
   */
    abstract public <T> int findPosition(Collection<? extends  T> collection,
                                     T value)
    ...
    abstract public <T> int findPosition(List<? extends  T> list,
                                     int start,
                                     int end,
                                     T value)
     { return FindPosition.execute(Iterators.BoundedIterator(list, start, end), value); }

    abstract public <T> int findPosition(Iterator<? extends  T> iterator,
                                     T value)
     { return FindPosition.execute(iterator, value); }

    abstract public <T> int findPositionIf(Collection<T> collection,
    ...
    abstract public <T> int findPositionIf(List<T> list,
                                       int start,
                                       int end,
                                       Predicate<? super  T> pred)
     { return FindPositionIf.execute(Iterators.BoundedIterator(list, start, end), pred); }

    abstract public <T> int findPositionIf(Iterator<T> iterator,
                                       Predicate<? super  T> pred)
   ...
   * in the sequence.
   */
    abstract public <T> T findIf(Collection<T> collection,
                             Predicate<? super  T> test)
    ...
    abstract public <T> T findIf(List<T> list,
                             int start,
                             int end,
                             Predicate<? super  T> test)
     { return FindIf.execute(Iterators.BoundedIterator(list, start, end), test); }

    abstract public <T> T findIf(Iterator<T> iterator,
                             Predicate<? super  T> test)
   ...
   * in the sequence.
   */
    abstract public <T> T findIfNot(Collection<T> collection, Predicate<? super  T> test) { return FindIfNot.execute(collection.iterator(), test); }

    abstract public <T> T findIfNot(Collection<T> collection, int start, int end, Predicate<? super  T> test) { return FindIfNot.execute(Iterators.BoundedIterator(collection.iterator(), start, end), test); }

    abstract public <T> T findIfNot(List<T> list, int start, int end, Predicate<? super  T> test) { return FindIfNot.execute(Iterators.BoundedIterator(list, start, end), test); }

    abstract public <T> T findIfNot(Iterator<T> iterator, Predicate<? super  T> test) { return FindIfNot.execute(iterator, test); }

  /**
   * Removes objects equal to <code>value</code> from the sequence.
   */
    abstract public <T> void remove(Collection<? extends  T> collection, T value) { Remove.execute(collection.iterator(), value); }

    abstract public <T> void remove(Collection<? extends  T> collection, int start, int end, T value) { Remove.execute(Iterators.BoundedIterator(collection.iterator(), start, end), value); }

    abstract public <T> void remove(List<? extends  T> list, int start, int end, T value) { Remove.execute(Iterators.BoundedIterator(list, start, end), value); }

    abstract public <T> void remove(Iterator<? extends  T> iterator, T value) { Remove.execute(iterator, value); }

  /**
   * Removes objects which match <code>test</code> from the sequence.
   */
    abstract public <T> void removeIf(Collection<T> collection, Predicate<? super  T> pred) { RemoveIf.execute(collection.iterator(), pred); }

    abstract public <T> void removeIf(Collection<T> collection, int start, int end, Predicate<? super  T> pred) { RemoveIf.execute(Iterators.BoundedIterator(collection.iterator(), start, end), pred); }

    abstract public <T> void removeIf(List<T> list, int start, int end, Predicate<? super  T> pred) { RemoveIf.execute(Iterators.BoundedIterator(list, start, end), pred); }

    abstract public <T> void removeIf(Iterator<T> iterator, Predicate<? super  T> pred) { RemoveIf.execute(iterator, pred); }
 ...
 /**
   ...
   */
    abstract public <T> List<T> partition(Collection<T> collection,
                                      Predicate<? super  T> pred)
    ...
    abstract public <T> List<T> partition(List<T> list,
                                      int start,
                                      int end,
                                      Predicate<? super  T> pred)
    ...
    abstract public <T> List<T> partition(Iterator<T> iterator,
                                      Predicate<? super  T> pred)
   ...
   * @see Comparator
   */
    abstract public <T> void unique(Collection<T> collection) { Unique.execute(collection.iterator(), null); }

    abstract public <T> void unique(Collection<T> collection, int start, int end) { Unique.execute(Iterators.BoundedIterator(collection.iterator(), start, end), null); }

    abstract public <T> void unique(List<T> list, int start, int end) { Unique.execute(Iterators.BoundedIterator(list, start, end), null); }

    abstract public <T> void unique(Iterator<T> iterator) { Unique.execute(iterator, null);   }

    abstract public <T> void unique(Collection<T> collection, Comparator<? super  T> comparator) { Unique.execute(collection.iterator(), comparator);  }

    abstract public <T> void unique(Collection<T> collection, int start, int end, Comparator<? super  T> comparator) { Unique.execute(Iterators.BoundedIterator(collection.iterator(), start, end), comparator);   }

    abstract public <T> void unique(List<T> list, int start, int end, Comparator<? super  T> comparator) { Unique.execute(Iterators.BoundedIterator(list, start, end), comparator); }

    abstract public <T> void unique(Iterator<T> iterator, Comparator<? super  T> comparator) { Unique.execute(iterator, comparator); }
