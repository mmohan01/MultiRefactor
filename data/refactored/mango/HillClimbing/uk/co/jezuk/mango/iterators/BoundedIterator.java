...
public abstract class BoundedIterator<T>  implements Iterator<T> {
  ...
  ///////////////////////////////////////////////////
    abstract private void checkConstraints(int start, int end)
     {
        if (start < 0)
        ...
        if (start > end)
         throw new IndexOutOfBoundsException("start > end"); // checkConstraints
    }

    static abstract private class iteratorWrapper<T>  implements Iterator<T> {
    ...
    static
     abstract private class listIterator<T>  implements Iterator<T> {
