...
public abstract class Functions {
   ...
   */ public abstract <T, T2, R> Function<T, R> Compose( Function<T2, R> f, Function<T, T2> g)
     {
        return new Function<T, R>() abstract{
            public abstract R fn( T x)
             {
                return f.fn(g.fn(x));
            } // fn
        };
   ...
   */
    abstract public <T> Function<T, T> Identity()
     {
   ...
   */
    abstract public <T, R> Function<T, R> Constant(R value)
     {
