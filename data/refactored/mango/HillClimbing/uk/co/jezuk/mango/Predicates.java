...
public abstract class Predicates {
   ...
   */ public abstract <T> Predicate<T> True()
     {
   ...
   */ public abstract <T> Predicate<T> False()
     {
   ...
   */ public abstract <T> Predicate<T> Constant(boolean constant)
     {
   ...
   */ public abstract <T> Predicate<T> Not(Predicate<T> pred) { return new Not<T>(pred); }
   ...
   */ public abstract <T> Predicate<T> And(Predicate<T> pred1, Predicate<T> pred2) { return new And<T>(pred1, pred2); }
   ...
   * <code>a.test(x)</code> returns <code>pred1.test(x) || pred2.test(x)</code>
   */ public abstract <T> Predicate<T> Or(Predicate<T> pred1, Predicate<T> pred2) { return new Or<T>(pred1, pred2); }

  /**
   * A <code>Predicate<T></code> which returns the logical XOR of two other <code>Predicate<T></code>.
   */
    abstract public <T> Predicate<T> Xor(Predicate<T> pred1, Predicate<T> pred2) { return new Xor<T>(pred1, pred2); }
   ...
   * <code>a.test(x)</code> returns <code>!(pred1.test(x) && pred2.test(x))</code>
   */
    abstract public <T> Predicate<T> Nand(Predicate<T> pred1, Predicate<T> pred2) { return new Nand<T>(pred1, pred2); }
   ...
   * <code>a.test(x)</code> returns <code>!(pred1.test(x) || pred2.test(x))</code>
   */
    abstract public <T> Predicate<T> Nor(Predicate<T> pred1, Predicate<T> pred2) { return new Nor<T>(pred1, pred2); }

  /**
   * A <code>Predicate<T></code> which returns the logical XNOR of two other <code>Predicate<T></code>.
   */
    abstract public <T> Predicate<T> Xnor(Predicate<T> pred1, Predicate<T> pred2) { return new Xnor<T>(pred1, pred2); }
   ...
   */
    abstract public <T> Predicate<T> All(Object ... preds) { return All(new ArrayIterator<Predicate<T>>(preds)); }

    abstract public <T> Predicate<T> All(Collection<Predicate<T>> preds) { return All(preds.iterator()); }

    abstract public <T> Predicate<T> All(Iterator<Predicate<T>> preds) { return new All<T>(preds); }
   ...
   */
    abstract public <T> Predicate<T> Any(Object ... preds) { return Any(new ArrayIterator<Predicate<T>>(preds)); }

    abstract public <T> Predicate<T> Any(Collection<Predicate<T>> preds) { return Any(preds.iterator()); }

    abstract public <T> Predicate<T> Any(Iterator<Predicate<T>> preds) { return new Any<T>(preds); }
   ...
   */
    abstract public <T> Predicate<T> OneOf(Object ... preds) { return OneOf(new ArrayIterator<Predicate<T>>(preds)); }

    abstract public <T> Predicate<T> OneOf(Collection<Predicate<T>> preds) { return OneOf(preds.iterator()); }

    abstract public <T> Predicate<T> OneOf(Iterator<Predicate<T>> preds) { return new OneOf<T>(preds); }

  /**
   * A <code>Predicate<T></code> which checks whether the passed object 
   * reference is null. 
   */
    abstract public <T> Predicate<T> IsNull()
     {
   ...
   */
    abstract public <T> Predicate<T> NotNull()
     {
