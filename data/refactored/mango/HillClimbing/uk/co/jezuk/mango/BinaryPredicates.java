 ...
 */
public abstract class BinaryPredicates {
  /////////////////////////////////////////////////
  // Binary Predicates
  /**
   * <code>BinaryPredicates</code> that always returns <code>true</code>
   */ public abstract <T1, T2> BinaryPredicate<T1, T2> True()
     {
   ...
   */ public abstract <T1, T2> BinaryPredicate<T1, T2> False()
     {
   ...
   */ public abstract <T1, T2> BinaryPredicate<T1, T2> Constant(boolean constant)
     {
   ...
   */ public abstract <T1, T2> BinaryPredicate<T1, T2> EqualTo()
     {
   ...
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> GreaterThan()
     {
   ...
   * <code>x</code> and <code>y</code> must implement the <code>java.lang.Comparable<code> interface.
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> GreaterThanEquals()
     {
   ...
   * <code>x</code> and <code>y</code> must implement the <code>java.lang.Comparable<code> interface.
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> LessThan()
     {
   ...
   * <code>x</code> and <code>y</code> must implement the <code>java.lang.Comparable<code> interface.
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> LessThanEquals()
     {
   ...
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> NotEqualTo()
     {
   ...
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> Not(BinaryPredicate<T1, T2> pred)
     {
   ...
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> And(BinaryPredicate<T1, T2> pred1,
   ...
   * <code>a.test(x,y)</code> returns <code>pred1.test(x,y) || pred2.test(x,y)</code>
   */
    abstract public <T1, T2> BinaryPredicate<T1, T2> Or(BinaryPredicate<T1, T2> pred1,
                                                    BinaryPredicate<T1, T2> pred2)
     {
