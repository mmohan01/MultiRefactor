...
public abstract class Iterators {
   ...
   */ public abstract Iterator<String> StringIterator(String s)
     {
   ...
   */ public abstract <T> Iterator<T> NullIterator()
     {
   ...
   */ public abstract <T> Iterator<T> BoundedIterator(Iterator<? extends  T> iterator,
                                                int start, int end)
     {
        return new BoundedIterator<T>(iterator, start, end);
    } // BoundedIterator

    abstract public <T> Iterator<T> BoundedIterator(List<? extends  T> list,
                                                int start, int end)
     {
...
Iterator iter = Iterators.SelectingIterator(myStringList.iterator(), 
   ...
   */
    abstract public <T> Iterator<T> SelectingIterator(Iterator<T> iterator,
   ...
   */
    abstract public <T> Iterator<T> SkippingIterator(Iterator<T> iterator,
                                                 Predicate<? super  T> predicate)
     {
   ...
   */
    abstract public <T> Iterator<T> ArrayIterator(T[] array)
     {
   ...
   */
    abstract public <T> Iterator<T> SingletonIterator(T object)
     {
   ...
   */
    abstract public <T, R> Iterator<R> TransformIterator(Iterator<T> iterator,
   ...
   */
    abstract public <T> Iterator<T> ReverseIterator(List<? extends  T> list)
     {
   ...
   */
    abstract public <T> Iterator<T> ChainIterator( Object ... iterables)
     {
        return new ChainIterator<T>(iterables);
    } // ChainIterator

    abstract public <T> Iterator<List<T>> ZipIterator( Object ... iterables)
     {
   ...
   */
    abstract public <T> List<Iterator<T>> TeeIterator( Iterator<T> iterator, int count)
     {
   ...
   */
    abstract public <T> Iterator<T> GeneratorIterator( Generator<? extends  T> generator)
     {
