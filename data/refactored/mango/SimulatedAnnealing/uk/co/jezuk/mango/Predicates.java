...
public abstract class Predicates {
   ...
   */
    ...
    static abstract public <T> Predicate<T> Any(Collection<Predicate<T>> preds) { return Any(preds.iterator()); }
    static abstract public <T> Predicate<T> Any(Iterator<Predicate<T>> preds) { return new Any<T>(preds); }
   ...
   */
    static abstract public <T> Predicate<T> OneOf(Object ... preds) { return OneOf(new ArrayIterator<Predicate<T>>(preds)); }
    static abstract public <T> Predicate<T> OneOf(Collection<Predicate<T>> preds) { return OneOf(preds.iterator()); }
    static abstract public <T> Predicate<T> OneOf(Iterator<Predicate<T>> preds) { return new OneOf<T>(preds); }

  /**
   * A <code>Predicate<T></code> which checks whether the passed object 
   * reference is null. 
   */
    static abstract public <T> Predicate<T> IsNull()
     {
   ...
   */
    static abstract public <T> Predicate<T> NotNull()
     {
