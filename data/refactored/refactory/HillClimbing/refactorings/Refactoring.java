...
public abstract class Refactoring extends TwoPassTransformation {
    ...
    public abstract void transform(ProblemReport p)
     {
    ...
    protected abstract String currentModifier(VisibilityModifier vm)
     {
    ...
    protected abstract int visibilityUp(VisibilityModifier vm)
     {
    ...
    protected abstract String refactoredUpModifier(VisibilityModifier vm)
     {
    ...
    protected abstract int visibilityDown(VisibilityModifier vm)
     {
        if (vm instanceof Public)
            return AccessFlags.PROTECTED;
         else if (vm instanceof Protected)
    ...
    protected abstract String refactoredDownModifier(VisibilityModifier vm)
     {
        if (vm instanceof Public)
            return "protected";
         else if (vm instanceof Protected)
    ...
    protected abstract String getFileName(String input)
     {
    ...
    public abstract String getRefactoringInfo()
     {
