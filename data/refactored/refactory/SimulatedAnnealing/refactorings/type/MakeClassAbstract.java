...
public abstract class MakeClassAbstract extends Refactoring {
    ...
    public abstract ProblemReport analyze(int iteration, int unit, int element)
     {
        ...
        super.refactoringInfo = "Iteration " + iteration + ": \"Make Class Abstract\" applied at class " + super.getFileName(getSourceFileRepository().getKnownCompilationUnits().get(unit).getName()) + " to element " + pe.getClass().getSimpleName() + " (" + ((TypeDeclaration) pe).getName() + ")";
