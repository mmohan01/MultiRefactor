...
public abstract class DecreaseClassSecurity extends Refactoring {
    ...
    public abstract ProblemReport analyze(int iteration, int unit, int element)
     {
        ...
        TypeDeclaration td = (TypeDeclaration) pe;
            ...
            super.refactoringInfo = "Iteration " + iteration + ": \"Decrease Class Security\" applied at class " + super.getFileName(getSourceFileRepository().getKnownCompilationUnits().get(unit).getName()) + " to element " + pe.getClass().getSimpleName() + " (" + ((TypeDeclaration) pe).getName() + ") from " + super.currentModifier(td.getVisibilityModifier()) + " to " + super.refactoredDownModifier(td.getVisibilityModifier());
