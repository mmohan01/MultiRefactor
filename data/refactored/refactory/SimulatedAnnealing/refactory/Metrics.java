...
public abstract class Metrics {
    ...
    public abstract List<CompilationUnit> getUnits()
     {
        return this.units;
    }

    public abstract void setUnits(List<CompilationUnit> units)
     {
        this.units = units;
    }
    ...
    public abstract int classDeclarationAmount()
     {
        int classCounter = 0;
    ...
    public abstract int methodDeclarationAmount()
     {
        int methodCounter = 0;
        this.tw = new ForestWalker(this.units);
    ...
    public abstract int methodsPerType()
     {
        int typeCounter = 0;
        int methodCounter;
        this.tw = new ForestWalker(this.units);
    ...
    public abstract float abstractness()
     {
        int typeCounter = 0;
    ...
    public abstract int abstractAmount()
     {
    ...
    public abstract int staticAmount()
     {
        int staticCounter = 0;
        this.tw = new ForestWalker(this.units);
    ...
    public abstract int finalAmount()
     {
        int finalCounter = 0;
        this.tw = new ForestWalker(this.units);
    ...
    public abstract int innerClassAmount()
     {
    ...
    public abstract int childAmount()
     {
        int childCounter = 0;
    ...
    public abstract int fileAmount()
     {
    ...
    public abstract int identifier(VisibilityModifier vm)
     {
