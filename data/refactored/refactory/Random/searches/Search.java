...
public final class Search {
    ...
    protected int[] getNeighbour(int currentUnit, int currentElement, int iteration, List<Refactoring> refactorings,
    ...
    public final void setServiceConfiguration(CrossReferenceServiceConfiguration sc)
     {
        this.sc = sc;
    }
