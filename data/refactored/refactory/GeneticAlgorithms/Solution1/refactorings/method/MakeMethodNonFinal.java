    ...
    public ProblemReport analyze(int iteration, int unit, int element)
     {
        ...
        super.refactoringInfo = "Iteration " + iteration + ": \"Make Method Non Final\" applied at class " + super.getFileName(getSourceFileRepository().getKnownCompilationUnits().get(unit).getName()) + " to element " + pe.getClass().getSimpleName() + " (" + ((MethodDeclaration) pe).getName() + ")";
