    ...
    public ProblemReport analyze(int iteration, int unit, int element)
     {
        ...
        super.refactoringInfo = "Iteration " + iteration + ": \"Make Class Concrete\" applied at class " + super.getFileName(getSourceFileRepository().getKnownCompilationUnits().get(unit).getName()) + " to element " + pe.getClass().getSimpleName() + " (" + ((TypeDeclaration) pe).getName() + ")";
