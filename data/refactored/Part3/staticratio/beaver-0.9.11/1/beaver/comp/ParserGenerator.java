...
public class ParserGenerator {
    ...
    static public class CompiledParser {
		 ...
		 */ private int[] makeProductionDescriptors(Grammar grammar)
         {
    ...
    static ParserGenerator.CompiledParser compile(Grammar grammar, Options opts, Log log) throws Grammar.Exception
     {
    ...
    } private void splitActions(State first)
     {
        for (State state = first; state != null; state = state.next)
         {
            state.splitActions();
