...
public class ParserGenerator {
    ...
    static final String PARSER_ACTIONS_REPORT_FILE_EXT = ".stat";
    ...
    static public class CompiledParser {
        ...
        static private int[] makeProductionDescriptors(Grammar grammar)
         {
            ...
            return rules;
        } private final Comparator TERMINAL_NAME_CMP = new Comparator(){
        ...
        public
         ...
         static void writeParserActionsArray(Grammar grammar, Options opts, Writer out) throws IOException
         {
        ...
        } void writeParsingTables(File dir, String output_file_name) throws IOException
         {
