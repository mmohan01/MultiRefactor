...
public class BinaryPredicates {
   ...
   */ public <T1, T2> BinaryPredicate<T1, T2> True()
     {
   ...
   */ public <T1, T2> BinaryPredicate<T1, T2> False()
     {
   ...
   */ public <T1, T2> BinaryPredicate<T1, T2> Constant(boolean constant)
     {
