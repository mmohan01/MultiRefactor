...
public class Algorithms {
   ...
   */ public <T> List<T> intersection(Collection<? extends  T> coll1,
                     Collection<? extends  T> coll2)
     { return Intersection.execute(coll1.iterator(), coll2, new ArrayList<T>()); } public <T, C extends  Collection<? super  T>>
                  C intersection(Collection<? extends  T> coll1,
                         Collection<? extends  T> coll2,
                         C results)
     { return Intersection.execute(coll1.iterator(), coll2, results); } public <T> List<T> intersection(Iterator<? extends  T> iter1,
                     Collection<? extends  T> coll2)
     { return Intersection.execute(iter1, coll2, new ArrayList<T>()); } public <T, C extends  Collection<? super  T>>
                  C intersection(Iterator<? extends  T> iter1,
                         Collection<? extends  T> coll2,
                         C results)
     { return Intersection.execute(iter1, coll2, results); } public <T> List<T> intersection(Iterator<? extends  T> iter1,
                     Iterator<? extends  T> iter2)
     { return Intersection.execute(iter1, iter2, new ArrayList<T>()); } public <T, C extends  Collection<? super  T>>
                  C intersection(Iterator<? extends  T> iter1,
                         Iterator<? extends  T> iter2,
                         C results)
