...
public class Predicates {
   ...
   */ public <T> Predicate<T> OneOf(Object ... preds) { return OneOf(new ArrayIterator<Predicate<T>>(preds)); } public <T> Predicate<T> OneOf(Collection<Predicate<T>> preds) { return OneOf(preds.iterator()); } public <T> Predicate<T> OneOf(Iterator<Predicate<T>> preds) { return new OneOf<T>(preds); }
