...
public class Generators {
   ...
   */ public Generator<Integer> IntegerSequence() { return new IntegerSequence(); } public Generator<Integer> IntegerSequence(int seed) { return new IntegerSequence(seed); } public Generator<Integer> IntegerSequence(Integer seed) { return new IntegerSequence(seed); }

  /**
   * Returns seed, seed, ... on successive calls to fn()
   */ public <T> Generator<T> ConstantSequence(T constant) { return new ConstantSequence<T>(constant); }
} // class Generators
