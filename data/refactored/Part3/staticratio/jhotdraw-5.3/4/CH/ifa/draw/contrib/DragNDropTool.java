...
//		System.out.println("Visible Image support = " + dragSource.isDragImageSupported());
    ...
    public void mouseUp(MouseEvent e, int x, int y) {
        ...
        if (
        fChild != null) // JDK1.1 doesn't guarantee mouseDown, mouseDrag, mouseUp
            fChild.
        mouseUp(e, x, y);
        fChild = null;
    }
...
//        System.out.println("DropTargetDragEvent-dragEnter");
	 ...
	 */
     public static void dragOver(DropTargetDragEvent dtde) {
        supportDropTargetDragEvent(dtde);
    }
    /**
...
//                System.out.println("DragSourceDropEvent-ACTION_COPY");
	 ...
	 */
    public static void dragOver(DragSourceDragEvent dsde) {
    }
    /**
...
//End DragSourceListener Interface
	 ...
	 */
    protected Object ProcessReceivedData(DataFlavor flavor, Transferable transferable) {
