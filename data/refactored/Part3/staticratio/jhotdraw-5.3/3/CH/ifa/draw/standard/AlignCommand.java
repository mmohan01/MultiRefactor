...
public class AlignCommand extends AbstractCommand {
    ...
    public static abstract class Alignment {
		 ...
		 */
        public static Alignment CENTERS = new Alignment("Centers"){
            public void moveBy(Figure f, Rectangle anchor) {
                Rectangle rr = f.displayBox();
    ...
    public void execute() {
        ...
        getUndoActivity().
        setAffectedFigures(new FigureEnumerator(view().selection()));
    ...
    public static class UndoActivity extends UndoableAdapter {
        ...
        public boolean undo() {
            ...
            while (k.hasMoreElements()) {
                ...
                f.
                moveBy(-currentPoint.x + originalPoint.x,
        ...
        public void setAppliedAlignment(Alignment newAlignment) {
