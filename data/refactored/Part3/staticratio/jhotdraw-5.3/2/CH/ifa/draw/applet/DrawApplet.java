 ...
 */
public abstract class DrawApplet
        extends JApplet
    ...
    public static String        IMAGES = fgDrawPath + "images/";
    ...
    public String[] getRequiredVersions() {
        ...
        requiredVersions[
        0] = VersionManagement.getPackageVersion(DrawApplet.class.getPackage());
