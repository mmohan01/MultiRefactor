...
public class XmlRpcWorker {
     ...
     */
    public static Object invokeHandler(Object handler, XmlRpcServerRequest request, XmlRpcContext context)
        throws Exception
     {
        long now = 0;
     ...
     */
    public XmlRpcContext defaultContext(String user, String password)
     {
