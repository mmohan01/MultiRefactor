...
public class SunSSLTransportFactory implements XmlRpcTransportFactory {
    ...
    public static String TRANSPORT_TRUSTMANAGER = "hostnameverifier";

    protected final String TRANSPORT_HOSTNAMEVERIFIER = "trustmanager";

    // The openTrustManager trusts all certificates
    private X509TrustManager openTrustManager = new X509TrustManager(){
    ...
    private HostnameVerifier openHostnameVerifier = new HostnameVerifier(){
