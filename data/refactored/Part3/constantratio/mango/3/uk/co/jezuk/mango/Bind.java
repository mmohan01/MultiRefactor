...
public class Bind {
   ...
   */
    static public final <T1, T2, R> Function<T2, R> First(final BinaryFunction<T1, T2, R> f,
                                                  final T1 c)
     {
   ...
   */
    static public final <T1, T2> Predicate<T2> First(final BinaryPredicate<T1, T2> p,
                                             final T1 c)
     {
