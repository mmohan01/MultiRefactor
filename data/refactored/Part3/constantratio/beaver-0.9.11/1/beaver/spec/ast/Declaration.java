...
public abstract class Declaration extends Node {
    ...
    static public abstract class CodeContainer extends Declaration {
        ...
        public CodeContainer(Symbol code)
         {
            this.code = code;
        }
    ...
    static public class Error extends Declaration {
        public static void accept(TreeWalker walker)
         {
            walker.visit(this);
        }
    }
    ...
    static public final class Implements extends SymbolsContainer {
    ...
    static public final class Terminals extends SymbolsContainer {
    ...
    static public final class TypeOf extends SymbolsContainer {
