...
public class ParserGenerator {
    ...
    static public final String SERIALIZED_PARSER_TABLES_FILE_EXT = ".spec"; final String PARSER_ACTIONS_REPORT_FILE_EXT = ".stat";
    ...
    static public final Grammar parseGrammar(SrcReader reader, Log log) throws IOException, Parser.Exception, Grammar.Exception
     {
