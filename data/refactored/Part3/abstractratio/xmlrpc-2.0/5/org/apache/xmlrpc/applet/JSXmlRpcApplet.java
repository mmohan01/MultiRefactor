...
public class JSXmlRpcApplet extends XmlRpcApplet {
    ...
    public void addIntArgToStruct(Hashtable struct, String key, final int value)
     {
    ...
    public void addIntArgToArray(Vector ary, final int value)
     {
    ...
    public void addDoubleArgToStruct(final Hashtable struct, String key, float value)
     {
