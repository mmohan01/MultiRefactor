...
public class SimpleXmlRpcClient {
     ...
     * @throws IOException
     */
    public final Object execute(String method, Vector params)
...
class XmlRpcSupport extends HandlerBase {
    ...
    final String types[] = { "String", "Integer", "Boolean", "Double",
     ...
     *          problems.
     */
    public final Object execute(String method, Vector arguments)
            throws XmlRpcException, IOException
     {
        fault = false;
        long now = System.currentTimeMillis();
