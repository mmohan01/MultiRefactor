...
class XmlWriter extends OutputStreamWriter {
     ...
     */
    public static String forceUnicode(String encoding)
     {
     ...
     */
    public static String canonicalizeEncoding(String javaEncoding)
     {
     ...
     * @throws IOException
     */
    public void emptyElement(String elem) throws IOException
     {
        write('<');
        write(elem);
    ...
    protected void setTypeDecoder(TypeDecoder newTypeDecoder)
     {
