...
public  class SplitPaneDrawApplication extends DrawApplication {
	 ...
	 */
    public JComponent createContents(DrawingView view) {
	 ...
	 */
    public JSplitPane createSplitPane(DrawingView view) {
	 ...
	 */
    protected void setLeftComponent(JComponent newLeftComponent) {
	 ...
	 */
    protected void setRightComponent(JComponent newRightComponent) {
