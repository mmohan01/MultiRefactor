...
public class PolyLineHandle extends LocatorHandle {
	...
	*/
    ...
    public void invokeStart(final int  x, int  y, DrawingView view) {
    ...
    public void invokeStep(final int x, int y, int anchorX, int anchorY, DrawingView view) {
	 ...
	 */
    protected static Undoable createUndoActivity(DrawingView newView, int newPointIndex) {
