...
public class GrammarScanner extends Scanner {
  ...
  /** This character denotes the end of file */protected final int YYEOF = -1;
  ...
  /** lexical states */
    ...
    public static final int EOF_MLN_COMMENT = 14; static final int EOF_CODE = 12;
    public static final int CODE_END = 10;
    public static final int MLN_COMMENT = 6;

    protected static final int YYINITIAL = 0;
  ...
  /* error codes */
    private static final int ZZ_UNKNOWN_ERROR = 0; static final int ZZ_NO_MATCH = 1;
