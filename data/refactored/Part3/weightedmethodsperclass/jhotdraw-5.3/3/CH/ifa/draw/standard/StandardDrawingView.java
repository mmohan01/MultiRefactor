...
public final  class StandardDrawingView
        extends JPanel
	 ...
	 * inside the view.
	 */
    private static Point fLastClick;
...
//			cmd.viewSelectionChanged(this);
    ...
    public void drawPainters(Graphics g, Vector v) {
