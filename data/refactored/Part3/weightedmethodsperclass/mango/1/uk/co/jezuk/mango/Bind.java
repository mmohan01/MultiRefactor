...
public final class Bind {
   ...
   */
    static public <T1, T2, R> Function<T2, R> First(final BinaryFunction<T1, T2, R> f, T1 c)
     {
   ...
   */
    static public <T1, T2> Predicate<T2> First(final BinaryPredicate<T1, T2> p, T1 c)
     {
   ...
   */
    public
     static <T1, T2, R> Function<T1, R> Second(final BinaryFunction<T1, T2, R> f, T2 c)
     {
   ...
   */
    static public <T1, T2> Predicate<T1> Second(final BinaryPredicate<T1, T2> p, T2 c)
     {
