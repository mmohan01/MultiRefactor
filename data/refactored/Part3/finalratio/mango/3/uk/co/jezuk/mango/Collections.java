...
public class Collections {
   ...
   * list.add("nose");</code>
   */
    static public final <T> List<T> list(final T ... values)
     {
        return ListFactory.list(values);
    } // list

    static public final <T> List<T> list(final Iterator<T> values)
     {
        return ListFactory.list(values);
    } // list

    static public final <T> List<T> list(final Collection<T> values)
     {
