...
public class Adapt {
   ...
   */
    static public final Function Method(final Object obj, final String methodName)
     {
        return wrapMethod(obj.getClass(), obj, methodName, null, null);
    } // Method
    @
    SuppressWarnings("unchecked")
     static final public <T, Void> Function<T, Void> Method(final Object obj,
    ...
    @
    SuppressWarnings("unchecked")
     static final public <T, R> Function<T, R> Method(final Object obj,
                                             final String methodName,
                                             final Class<T> argType,
   ...
   * parameter one of them will be called, but you can't determine which.
   */
    static public final Function Method(final Class klass, final String methodName)
     {
  ...
  ////////////////////////////////////////////////////////////
  ////////////////////////////////////////////////////////////
    static Function wrapMethod(final Class<?> klass,
                                     final Object obj,
                                     final String methodName,
                                     final Class<?> argType,
   ...
   * @see Function
   */
    static public final Function ArgumentMethod(final String methodName)
     {
        return new Function(){
    ...
    @SuppressWarnings("unchecked")
     static final public <T, Void> Function<T, Void> ArgumentMethod(final String methodName,
                                                           final Class<T> argType)
     {
    ...
    @
    SuppressWarnings("unchecked")
     static final public <T, R> Function<T, R> ArgumentMethod(final String methodName,
                             final Class<T> argType,
                             final Class<R> returnType)
     {
