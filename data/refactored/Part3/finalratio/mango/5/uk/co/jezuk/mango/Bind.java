...
public class Bind {
   ...
   */
    static <T1, T2, R> Function<T2, R> First(final BinaryFunction<T1, T2, R> f,
                                                  final T1 c)
     {
   ...
   */
    private
     static <T1, T2> Predicate<T2> First(final BinaryPredicate<T1, T2> p,
                                             final T1 c)
     {
        return new Predicate<T2>(){ BinaryPredicate<T1, T2> test_;
            private T1 c_;
            { test_ = p; c_ = c;
            }
    ...
    static public <T1, T2, R> Function<T1, R> Second(final BinaryFunction<T1, T2, R> f,
                                                   final T2 c)
     {
        return new Function<T1, R>(){
            ...
            public R fn(final T1 arg) { return fn_.fn(arg, c_); }
        };
    } // Second
