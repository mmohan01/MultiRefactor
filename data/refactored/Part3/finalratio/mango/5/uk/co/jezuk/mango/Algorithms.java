...
public final class Algorithms {
   ...
   */
    private
     static <T> T findIfNot(Collection<T> collection, Predicate<? super  T> test) { return FindIfNot.execute(collection.iterator(), test); }

    private
     static <T> T findIfNot(Collection<T> collection, int start, int end, Predicate<? super  T> test) { return FindIfNot.execute(Iterators.BoundedIterator(collection.iterator(), start, end), test); }

    private
     static <T> T findIfNot(List<T> list, int start, int end, Predicate<? super  T> test) { return FindIfNot.execute(Iterators.BoundedIterator(list, start, end), test); }

    private
     static <T> T findIfNot(Iterator<T> iterator, Predicate<? super  T> test) { return FindIfNot.execute(iterator, test); }
