...
public class Algorithms {
 ...
 /**
   ...
   * @see Iterator
   * @see Comparator
   */ public <T> void unique(Collection<T> collection) { Unique.execute(collection.iterator(), null); } public <T> void unique(Collection<T> collection, int start, int end) { Unique.execute(Iterators.BoundedIterator(collection.iterator(), start, end), null); }
