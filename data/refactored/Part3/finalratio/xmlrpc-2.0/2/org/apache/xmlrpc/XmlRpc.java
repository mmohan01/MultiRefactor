...
public abstract class XmlRpc extends HandlerBase
     ...
     */
    private final String DEFAULT_PARSER = MinML.class.getName();
    ...
    private static final Hashtable saxDrivers = new Hashtable(8);
     ...
     */
    public XmlRpcException decodeException(Object result)
     ...
     * object.
     */
    public abstract void objectParsed(Object what);
