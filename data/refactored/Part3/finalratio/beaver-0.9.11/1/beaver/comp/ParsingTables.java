 ...
 */
class ParsingTables {
    /** Start of the list of all states. */ final State first_state;
    ...
    protected boolean tryInsertActions(Action.List action_list, int offset)
     {
    ...
    } final int UNUSED_OFFSET = Integer.MIN_VALUE; int countStates(State state)
     {
