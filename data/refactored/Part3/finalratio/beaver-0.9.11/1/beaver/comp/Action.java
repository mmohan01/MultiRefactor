...
class Action {
         ...
         static class Conflict extends Type {
            static class ShiftReduce extends Conflict {
                ...
                protected
                 ...
                 static String makeDescription(Shift shift_act, Reduce reduce_act, State state, String reason)
                 {
            ...
            static class ReduceReduce extends Conflict {
                ...
                protected
                 ...
                 static String makeDescription(Reduce act1, Reduce act2, State state, String reason)
                 {
    ...
    static class List {
        ...
        public void removeResolvedActions()
         {
