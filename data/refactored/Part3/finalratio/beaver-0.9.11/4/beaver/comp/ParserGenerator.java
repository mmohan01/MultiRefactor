...
public class ParserGenerator {
    ...
    static public class CompiledParser {
        ...
        static private final String encode(byte[] bytes) throws IOException
         {
        ...
        static private final void encode(int c, StringBuffer text)
         {
            if (c < 10)
    ...
    static void checkAndResolveConflicts(State first, Log log) throws Grammar.Exception
     {
        int num_conflicts = 0;
        for (State state = first; state != null; state = state.next)
         {
