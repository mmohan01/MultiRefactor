 ...
 */
abstract
 class Action { final Comparator LOOKAHEAD_ID_COMPARATOR = new Comparator(){
    ...
    static class Type {
        ...
        abstract
         static class Conflict extends Type {
            static final class ShiftReduce extends Conflict {
                ...
                } private String makeDescription(Shift shift_act, Reduce reduce_act, State state, String reason)
                 {
            ...
            static class ReduceReduce extends Conflict {
                ...
                } private String makeDescription(Reduce act1, Reduce act2, State state, String reason)
                 {
