...
public final class ParserGenerator {
    ...
    static public final class CompiledParser {
        /**
        ...
        static final Comparator TERMINAL_NAME_CMP = new Comparator(){
        ...
        public final void writeActionsReport(File dir, String output_file_name) throws IOException
         {
    ...
    static private void findLookaheads(final State first)
     {
        boolean more_found;
        do
         {
    ...
    static private void buildActions(Grammar grammar, final State first)
     {
    ...
    static private void checkAndResolveConflicts(final State first, Log log) throws Grammar.Exception
     {
        int num_conflicts = 0;
        for (State state = first; state != null; state = state.next)
         {
    ...
    static private void checkUnreducibleProductions(Grammar grammar, final State first, Log log) throws Grammar.Exception
     {
        for (State state = first; state != null; state = state.next)
         {
    ...
    static private void compressActions(final State first)
     {
        for (State state = first; state != null; state = state.next)
         {
    ...
    static private void splitActions(final State first)
     {
        for (State state = first; state != null; state = state.next)
         {
            state.splitActions();
