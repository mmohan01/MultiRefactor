 ...
 */
public final class StandardLayouter implements Layouter {
    ...
    public Rectangle calculateLayout(Point origin, Point corner) {
        ...
        // layout enclosed Layoutable and find maximum width
         FigureEnumeration enume = getLayoutable().figures();
        while (enume.hasMoreElements()) {
            Figure currentFigure = enume.nextFigure();
            Rectangle r = null;
            if (currentFigure instanceof Layoutable) {
                ...
                r.
                grow(layoutStrategy.getInsets().left + layoutStrategy.getInsets().right,
