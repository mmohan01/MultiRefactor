...
public class BoxHandleKit {
	 ...
	 * figure.
	 */ public void addCornerHandles(Figure f, Vector handles) {
    ...
    } public Handle west(Figure owner) {
...
class ResizeHandle extends LocatorHandle {
    ...
    public static class UndoActivity extends UndoableAdapter { Rectangle myOldDisplayBox;
