...
public class MDI_DrawApplication extends DrawApplication implements InternalFrameListener {
	...
	*/
    ...
    protected MDI_InternalFrame createInternalFrame(DrawingView view) {
        ...
        Enumeration enume = mdiListeners.elements();
        while (enume.hasMoreElements()) {
            internalFrame.addInternalFrameListener((InternalFrameListener)enume.nextElement());
        }
	...
	*/
	 ...
	 */
    protected void removeInternalFrameListener(InternalFrameListener oldMDIListener) {
