...
public class AboutAuthorPanel extends GeneralOptionPanel {
	...
	public AboutAuthorPanel(GanttProject parent)
	{
	    ...
	    modelauthors.addField(new AuthorsInfo("",""));
        modelauthors.addField(new AuthorsInfo("SUPPORTED TRANSLATIONS:", ""));
        modelauthors.addField(new AuthorsInfo("---------------", "---------------"));
        modelauthors.addField(new AuthorsInfo("Zheko Zhekov (Bulgarian)", ""));
        modelauthors.addField(new AuthorsInfo("Jan Madsen (Danish)", ""));
        modelauthors.addField(new AuthorsInfo("Alexandre Thomas (French)", ""));
        modelauthors.addField(new AuthorsInfo("Andreas Stuff (German)", ""));
        modelauthors.addField(new AuthorsInfo("Roger Andresen (Norvegian)", ""));
        modelauthors.addField(new AuthorsInfo("Dmitry Barashev (Russian)", ""));
        modelauthors.addField(new AuthorsInfo("Luyin Zhao (Simplified Chinese)", "lzhao2@yahoo.com"));
        modelauthors.addField(new AuthorsInfo("Changjiang Wei (Simplified Chinese)", "weichangjiang@263.net"));
        modelauthors.addField(new AuthorsInfo("",""));        
        modelauthors.addField(new AuthorsInfo("---------------", "---------------"));
