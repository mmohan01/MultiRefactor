	...
	public RunConfigPanelBase() {
		...
		gl_metricsPanel.setHorizontalGroup(
			gl_metricsPanel.createParallelGroup(Alignment.TRAILING)
				.addComponent(normalMetricsPanel, Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
				.addComponent(availableMetricsPanel, GroupLayout.DEFAULT_SIZE, 507, Short.MAX_VALUE)
		);
		gl_metricsPanel.setVerticalGroup(
			gl_metricsPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(Alignment.TRAILING, gl_metricsPanel.createSequentialGroup()
					.addComponent(availableMetricsPanel, GroupLayout.DEFAULT_SIZE, 262, Short.MAX_VALUE)
					.addPreferredGap(ComponentPlacement.RELATED)
					.addComponent(normalMetricsPanel, GroupLayout.PREFERRED_SIZE, 142, GroupLayout.PREFERRED_SIZE))
		);
