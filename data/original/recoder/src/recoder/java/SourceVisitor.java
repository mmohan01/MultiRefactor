...
public abstract class SourceVisitor {
    ...
    /**
     * Visits the specified annotation declaration. Defaults to do nothing.
     * 
     * @param x
     *            the program element to visit.
     */
    ...
    /**
     * Visits the specified union-type parameter declaration. The default implementation
     * does nothing.
     * 
     * @param x
     *            the program element to visit.
     */
    public void visitUnionTypeParameterDeclaration(UnionTypeParameterDeclaration x) {
        // defaults to nothing
    }
    ...
    /**
     * Visits the specified declaration specifier. Defaults to do nothing.
     * 
     * @param x
     *            the program element to visit.
     */
    ...
    /**
     * Visits the specified type parameter. Defaults to do nothing.
     * 
     * @param x
     *            the program element to visit.
     */
