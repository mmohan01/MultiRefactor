/***************************************************************************
                           GanttPeoplePanel.java  -  description
                             -------------------
    begin                : feb 2003
...
public class GanttPeoplePanel extends JPanel
{
	...
	/** Create a new Human */
	public void newHuman(GanttPeople people)
	{
		if(people!=null) model.addRow(people);
	}
	...
	public void deleteHuman(GanttProject parent)
	{
		...
		if(people!=null)
		{
			...
			GanttDialogInfo gdi = new GanttDialogInfo(parent,lang, GanttDialogInfo.WARNING,
							GanttDialogInfo.YES_NO_OPTION,lang.msg6()+people.toString()+"??",lang.warning());
			gdi.show();
