...
public class GanttIO
{
			 ...
			 GanttTree tree, GanttPeoplePanel peop,GanttGraphicArea area, GanttLanguage language)
	{
		...
		try {
			...
			GanttDialogInfo gdi = new GanttDialogInfo(prj,language, GanttDialogInfo.ERROR,
				GanttDialogInfo.YES_OPTION,language.msg2() + file.getName(),language.error());
			gdi.show();
		}
	}
