	...
	public void run() 
	{
		...
		if (this.printAll)
		{
			...
			{			
				...
				if (super.c.getNonPriorityClasses() == null)
					priorityRatio = m.priorityClasses(super.c.getPriorityClasses());
				else
					priorityRatio = m.priorityClasses(super.c.getPriorityClasses(), super.c.getNonPriorityClasses());
				...
				try 
				{
					...
					bw.append(String.format("\r\n\r\n**Priority objective score: %d**", priorityRatio));
					bw.close();
				}
				catch (IOException e) 
				{
					System.out.println("\r\nEXCEPTION: Cannot output priority value to text file.");
					System.exit(1);
				}
			}
		}
