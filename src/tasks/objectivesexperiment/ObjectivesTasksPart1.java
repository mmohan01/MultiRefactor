...
public class ObjectivesTasksPart1 extends Tasks
{
	...
	{		
		...
		searches.add(new ManyObjectiveSearch(sc, cM1, refactorings, sourceFiles[0], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM1, refactorings, sourceFiles[0], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM1, refactorings, sourceFiles[0], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM1, refactorings, sourceFiles[0], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM1, refactorings, sourceFiles[0], 100, 50, 0.2f, 0.8f));
		...
		searches.add(new ManyObjectiveSearch(sc, cM2, refactorings, sourceFiles[1], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM2, refactorings, sourceFiles[1], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM2, refactorings, sourceFiles[1], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM2, refactorings, sourceFiles[1], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM2, refactorings, sourceFiles[1], 100, 50, 0.2f, 0.8f));
		...
		searches.add(new ManyObjectiveSearch(sc, cM3, refactorings, sourceFiles[2], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM3, refactorings, sourceFiles[2], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM3, refactorings, sourceFiles[2], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM3, refactorings, sourceFiles[2], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM3, refactorings, sourceFiles[2], 100, 50, 0.2f, 0.8f));
		...
		searches.add(new ManyObjectiveSearch(sc, cM4, refactorings, sourceFiles[3], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM4, refactorings, sourceFiles[3], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM4, refactorings, sourceFiles[3], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM4, refactorings, sourceFiles[3], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM4, refactorings, sourceFiles[3], 100, 50, 0.2f, 0.8f));
		...
		searches.add(new ManyObjectiveSearch(sc, cM5, refactorings, sourceFiles[4], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM5, refactorings, sourceFiles[4], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM5, refactorings, sourceFiles[4], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM5, refactorings, sourceFiles[4], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM5, refactorings, sourceFiles[4], 100, 50, 0.2f, 0.8f));
		...
		searches.add(new ManyObjectiveSearch(sc, cM6, refactorings, sourceFiles[5], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM6, refactorings, sourceFiles[5], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM6, refactorings, sourceFiles[5], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM6, refactorings, sourceFiles[5], 100, 50, 0.2f, 0.8f));
		searches.add(new ManyObjectiveSearch(sc, cM6, refactorings, sourceFiles[5], 100, 50, 0.2f, 0.8f));
		...
		for (int i = 0; i < searches.size(); i++)
		{
			...
			if (searches.get(i).getClass().getName().contains("ManyObjectiveSearch"))
			{
				...
				((ManyObjectiveSearch) searches.get(i)).setTopSolutionFlag(false);
			}
			else
			{
