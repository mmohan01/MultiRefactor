...
public class MakeMethodConcrete extends Refactoring 
{
	public MakeMethodConcrete(CrossReferenceServiceConfiguration sc) 
	{
		super(sc);
	}
	
	public MakeMethodConcrete() 
	{
		super();
	}
	...
	public ProblemReport analyze(int iteration, int unit, int element) 
	{
		...
		super.refactoringInfo = "Iteration " + iteration + ": \"Make Method Concrete\" applied at class " 
	...
	{
		if ((!md.isAbstract()) || (md.getASTParent() instanceof InterfaceDeclaration))
			return false;
		else
			return true;	
	}
